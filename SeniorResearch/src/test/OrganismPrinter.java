...
public class OrganismPrinter {
	...
	public void showOrganism(Organism organism, String title) {
		...
		Graph graph = new MultiGraph("Organism 1");
		...
		for (NodeGene node : organism.getNodeGenes().values()) {
		...
		for (ConnectionGene connection : organism.getConnectionGenes().values()) {
